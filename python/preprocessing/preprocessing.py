...
news_data_preprocessor = AdvancedNewsDataPreprocessor('../data/agricultural news from 2017.csv')
news_data_preprocessor.save_as_pickle('../data/preprocessed_news_all.pickle')

# for g in GRAINS:
#     news_data_preprocessor = NewsDataPreprocessor('../data/agricultural news from 2017.csv', g.lower())
