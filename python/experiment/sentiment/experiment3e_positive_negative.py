...
if is_jun:
    print(rs_pred.summary2(yname=grain,
...
if is_jun:
    ...
    print(np.around(np.dot(rs_pred.params[1:11], pc_result.components_), decimals=4))
...
if is_jun:
    ...
    coef = np.transpose(np.dot(rs_pred.params[1:11], pc_result.components_))
